...
public class ArrayInsertElement {
    ...
    public void insertElementInSameArray(Scanner s){
        System.out.println("Enter size of the array = ");
        int size = s.nextInt();                                                              //Taking input of size of Array
        int arr[]= new int[size+1];
        System.out.println("Enter elements of the array = ");                                //Taking input of elements in Array
    ...
    public void insertElementInNewArray(Scanner s){
        ...
        System.out.println("Enter elements of in the array = ");                              //Taking input of elements in Array
        for(int i=0; i<size; i++){
            arr[i]=s.nextInt();
        }
    ...
    public void usingArrayList(Scanner s){
        ...
        System.out.println("Initial Array list = ");         //Printing elements of initial Arraylist
        ...
        System.out.println("Final Array list = ");          //Printing elements after adding 30 at index 2 in  Arraylist
