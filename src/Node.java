public class Node {
    ...
    public static Node traversal(int a[]) {                                     //Inserting elements into linkedList
    ...
    public static Node insertElementAtHead(Node head, int val){
        if(head == null){
            return new Node(val);
        }
    ...
    public static Node insertElementByIndex(Node head, int i, int val){
        if(head==null){
            if(i==1){
                return new Node(val);
            }
    ...
    public static Node insertElementBeforeValue(Node head, int el, int val){
        if(head == null){
            return null;
